...
class UserAdmin(BaseUserAdmin):
    """Most of these below are just customization"""
    ordering = ['email']
    ...
    list_display_links = ['id', 'email'] #we want the id and email to be clickable on the Admin page
...
admin.site.register(User, UserAdmin) #register the User model class using the UserAdmin
