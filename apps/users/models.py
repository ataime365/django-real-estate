...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    USERNAME_FIELD = "email" #This username_field is used as the unique identifies, using email as username
    REQUIRED_FIELDS = ["username", "first_name", "last_name"] #when creating createsuperuser

    # Using the custom user we created, for queries
